...
# Contribute to Ory Ory Hydra Go Client<!-- omit in toc -->
...
Ory Hydra Go Client's direction. A great way to
do this is via
...
- **Help with open issues.** We have a lot of open issues for Ory Ory Hydra Go Client and
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/hydra-client-go/blob/master/.github/workflows/conventional_commits.yml)
